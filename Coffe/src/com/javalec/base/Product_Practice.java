...
public class Product_Practice extends JFrame implements ActionListener {	// 엔터키 액션넣기
...
//	"<html>안녕<br>안녀엉<p>세번</html>" 라벨 줄바꾸기
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Product_Practice frame = new Product_Practice();
...
//			btnHome.setIcon(new ImageIcon(Product_Practice.class.getResource("/com/javalec/image/btnHome.png")));
...
//				}
//			});
//			btnMenu.setIcon(new ImageIcon(Product_Practice.class.getResource("/com/javalec/image/btnMenu.png")));
...
//			btnOrder.setIcon(new ImageIcon(Product_Practice.class.getResource("/com/javalec/image/btnOrder.png")));
...
//			btnReview.setIcon(new ImageIcon(Product_Practice.class.getResource("/com/javalec/image/btnReview.png")));
...
//	}
	private JLabel getLblNewLabel_1() { // 와이파이
		if (lblNewLabel_1 == null) {
			lblNewLabel_1 = new JLabel("");
			lblNewLabel_1.setIcon(new ImageIcon(Product_Practice.class.getResource("/com/javalec/image/wifi.png")));
	...
	private JButton getBtnCoffe() {
		if (btnCoffe == null) {
			...
			btnCoffe.setIcon(new ImageIcon(Product_Practice.class.getResource("/com/javalec/image/opt 1.png")));
	...
	private JButton getBtnDrink() {
		if (btnDrink == null) {
			...
			btnDrink.setIcon(new ImageIcon(Product_Practice.class.getResource("/com/javalec/image/opt 2.png")));
	...
	private JButton getBtnDessert() {
		if (btnDessert == null) {
			...
			btnDessert.setIcon(new ImageIcon(Product_Practice.class.getResource("/com/javalec/image/opt 3.png")));
	...
	private JLabel getLblNewLabel_4() {
		if (lblNewLabel_4 == null) {
			...
			lblNewLabel_4.setIcon(new ImageIcon(Product_Practice.class.getResource("/com/javalec/image/options.png")));
...
//			lblBasket.setIcon(new ImageIcon(Product_Practice.class.getResource("/com/javalec/image/selectjang.png")));
...
//		if (lblgra == null) {
//			lblgra = new JLabel("");
//			lblgra.setIcon(new ImageIcon(Product_Practice.class.getResource("/com/javalec/image/layer.png")));
...
//				}
//			});
//			lblBuy.setIcon(new ImageIcon(Product_Practice.class.getResource("/com/javalec/image/selectbar.png")));
...
//			btnPlus.setIcon(new ImageIcon(Product_Practice.class.getResource("/com/javalec/image/select.png")));
...
//			btnMinus.setIcon(new ImageIcon(Product_Practice.class.getResource("/com/javalec/image/selectami.png")));
...
//			lblclickimg_1.setIcon(new ImageIcon(Product_Practice.class.getResource("/com/javalec/image/Group 49.png")));
...
//			btnExit.setIcon(new ImageIcon(Product_Practice.class.getResource("/com/javalec/image/akar-icons_cross.png")));
...
//				}
//			});
//			btnNewButton.setIcon(new ImageIcon(Product_Practice.class.getResource("/com/javalec/image/icon _cart_.png")));
...
//			lblCount.setIcon(new ImageIcon(Product_Practice.class.getResource("/com/javalec/image/Ellipse 7.png")));
